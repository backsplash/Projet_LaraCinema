...
@section('content')
<div class="row">
    <form enctype="multipart/form-data" action="{{route('administrators_store')}}" method="post" class="form-horizontal" novalidate>

        <div class="col-md-8">
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <span class="panel-title">Ajout d'un administrateur</span>
                </div>
                ...
                <div class="panel-body ">
                    <div class="form-group col-md-6">
                        ...
                        type="text" id="lastname" name="lastname" class="col-md-6 form-control" placeholder="Nom" required >
                    ...
                    <div class="form-group col-md-6 admin-form pull-right">
                        <label class="block mt15 switch switch-primary">

                            <input id="super_admin" type="checkbox" checked= "" value="admin" name="super_admin">
                    ...
                    <div class="form-group ">
                        <div class="col-md-12 ">
                            ...
                            <textarea id="description" rows="3" name="description" class="form-control summernote" placeholder="Année de naissance, cultures, passions..." required >{{ old('description')}}</textarea>
