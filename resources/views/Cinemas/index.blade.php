    ...
    <div class="row">
        <div class="col-md-10">
            ...
            <div class="col-md-4" style="margin-top:19px;">
                <a href="{{ route('cinemas_create')}}" class="btn btn-sm btn-system pull-right">
                        ...
                        @foreach($cinemas as $cinema)
                            <tr>
                                ...
                                <td class="text-center">
                                    <p><a href="{{ route('cinemas_edit', ['id'=>$cinema->id])}}" ><button type="button" class="btn btn-xs btn-warning">
                                                <i class="fa fa-pencil "></i>
                                            </button></a></p>
                                    <p><a href="{{ route('cinemas_delete', ['id'=>$cinema->id])}}" ><button type="button" class="btn btn-xs btn-danger">
                                                <i class="fa fa-times"></i>
                                            </button></a></p>
                                    <p><a href="{{ route('cinemas_read', ['id'=>$cinema->id])}}" ><button type="button" class="btn btn-xs btn-system">
