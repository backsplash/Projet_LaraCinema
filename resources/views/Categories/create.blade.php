...
@section('content')
    <div class="row">
        <form enctype="multipart/form-data" action="{{route('categories_store')}}" method="post" class="form-horizontal" novalidate>
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body ">
                        <div class="form-group col-md-6">
                            ...
                            <input value="{{ old('title')}}" type="text" id="title" name="title" class="col-md-6 form-control" placeholder="Titre de la catégorie" required >
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group ">
                            <div class="col-md-12">
                                ...
                                <textarea id="description" rows="3" name="description" class="form-control summernote" placeholder="Description de la catégorie" required >{{ old('description')}}</textarea>
